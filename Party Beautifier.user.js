...
function colorGradient(x) {
  if (coloringGradient == 'Shiny') {
    var pokeGradientLength = x.length
    //<span style="color: rgb(148, 183, 255);">Start</span>
    //<span style="color: rgb(99, 214, 168);">End</span>
    var divValr = parseInt(49/pokeGradientLength)
    var divValg = parseInt(31/pokeGradientLength)
    var divValb = parseInt(87/pokeGradientLength)
    var rbase = 148
    var gbase = 183
    var bbase = 255
    var r = rbase
