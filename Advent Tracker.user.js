...
(async () => {
    ...
    if (window.location.search.split('?id=')[1] != undefined) {
        ...
        previousAdvent = "The Last Advent Opened was " + previousAdvent + '!'
        await GM.setValue('previous_Advent', previousAdvent);
    }
    ...
    if (previousAdvent != null) {
        if (document.getElementsByClassName('title')[0].innerText == 'Christmas Advent Calendar!') {
            ...
            var customHTML = document.getElementsByClassName('contentcontent')[0].innerHTML
    ...
    if (document.getElementById('calendar') != undefined) {
        ...
        previousAdvent = parseInt(previousAdvent.split('The Last Advent Opened was ')[1].split('!')[0])
