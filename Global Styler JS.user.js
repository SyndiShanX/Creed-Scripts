...
synLeftMenu4 = '<div class="menu6"><ul>' + synMenuStart + synHTML3[4] + synMenuEnd
...
synRightMenu3 = '<div class="menu7"><ul>' + synMenuStart + '"header">Other' + synHTML8 + "</a></li>" + synHTML7[3].split('"header">Other</li>')[1].split("</ul>")[0] + "</ul></div>"
